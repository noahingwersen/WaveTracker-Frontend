        ...
        {loading ? (
          ...
          data && (
            <>
              ...
              <br />
              <b>Wave Height:</b>{' '}
              {(data.wave_height * meters_to_feet).toFixed(2)} ft
              <br />
              <b>Average Period:</b>{' '}
              {parseFloat(data.average_period).toFixed(2)} sec
              <br />
              <br />
              <b>Swell Height:</b>{' '}
              ...
              <br />
              <b>Swell Period:</b>{' '}
              {parseFloat(data.swell_avg_period).toFixed(2)} sec
              <br />
              <b>Swell Direction:</b>{' '}
              ...
              ft
              <br />
              <b>Sea Period:</b> {parseFloat(data.sea_avg_period).toFixed(2)}{' '}
              sec
              <br />
